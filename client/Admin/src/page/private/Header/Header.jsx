...
import { darkMode, lightMode } from '../../Redux/DarkMode';
 ...
 function Header(props) {
  ...
  const items = [
    { key: '1', label: `${t("SignUp")}`, to: '/Signup' },
  ];

  if (tokenUser) {
    items.push({ key: '2', label: `${t("LogOut")}`, onClick: handleLogout });
  } else {
...
<Layout>
  ...
  >
    <img src={imgLogo} style={{marginLeft:"27px"}} alt="LOGO" className="demo-logo-vertical" /> 
    <Menu
      mode="horizontal"
