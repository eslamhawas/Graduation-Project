  ...
  return (
    <>
      <div style={{ padding: "0px 20px" }}>
        <Row align="middle" justify="center" gutter={[16, 16]}>          <Col xs={24} sm={24} md={24} lg={12} xl={12}>
            <div
              style={{
                display: "flex",
          ...
          {!widthPage ? (
            ...
            >
              <DotLottieReact
                src="https://lottie.host/9f457eb7-6143-4171-8328-3e23c88f1501/lOEN3K4PFW.lottie"
                loop
                autoplay
              />
            </Col>
